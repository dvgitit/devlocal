...
# === EDIT HERE ===
$packageRepo = 'http://nexus.p2.komm-one.net:7071/repository/nuget-group'
...
$env:chocolateyIgnoreProxy = 'false' # ignore proxy
#$env:chocolateyProxyLocation = 'http://squid.kvnbw.de:3128' # explicit proxy
